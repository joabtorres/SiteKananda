...
<!--CATEGORIA DE IMOVEL-->
  ...
  <div id="imovel-home">
          <h3 class="imovel-nome">Terrenos Urbanos</h3>
          <?php
          ...
          <?php
            ...
            echo 'Não há terrenos urbanos disponíveis';
          }
        ...
        <!--PAGINAÇÃO-->
                <div class="row">
                  <div class="col-xs-12">
                      ...
                      <?php echo Funcao::gerarPaginacao(RAIZ.'terrenos-urbanos/page', $qtd_paginas, $pagina_atual, 'id="imovel-paginacao"', 'class="pagination"' ) ?>
