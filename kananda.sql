...
--
-- Máquina: localhost
-- Data de Criação: 05-Nov-2014 às 12:20
...
(13, 'fa', '6116afedcb0bc31083935c1c262ff4c9', 'fabricio@gmail.com', '2014-11-02 20:03:52'),
(14, 'endo', '5285f66a208bcaa5af5ea678badae4b2', 'fabricio@gmail.com', '2014-11-02 20:07:26'),
(17, 'TI', '', '', '2014-11-04 21:09:19');
...
(1, 'Kananda Imobiliária', 'site@kananda.com..br', 'Kananda', 'imagens/site/54563ba4538b8.jpg', '2014-10-22 21:09:46');
...
(80, 'teste', 'descricao teste', 'imagens/eventos/80-d', '2014-10-25 14:32:55'),
(81, 'teste', 'kananda', 'imagens/eventos/81-kananda', '2014-10-25 15:04:43');
...
(15, 3, 'img/imoveis/3-333/54539d92f0da3.jpg', '2014-10-31 14:32:50'),
(16, 2, 'img/imoveis/2-222/5456916207cd2.jpg', '2014-11-02 20:17:38'),
(18, 2, 'img/imoveis/2-222/54569184e6aaf.jpg', '2014-11-02 20:18:12'),
(19, 3, 'img/imoveis/3-333/5456919a54f95.jpg', '2014-11-02 20:18:34'),
(20, 4, 'img/imoveis/4-444/5457dae2d35b2.jpg', '2014-11-03 19:30:44');
...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  `area_edi` int(11) NOT NULL,
  `area_ter` int(11) NOT NULL,
  `perimetro_l` int(11) NOT NULL,
  `perimetro_c` int(11) NOT NULL,
...
(2, 222, 'CASA A VENDA', 'VENDA', 1, 1, 1, 1, 1, 1, '-4.265850', '-55.981934', 1, 1, 'CASA TERREA', '1', '1', '1', 'BOA ESPERANÇA', 'ITAITUBA', '', 'imóvel a alugar\r\n', '1', 'img/imoveis/2-222', '2014-10-31 11:40:07'),
(3, 333, 'CASA PARA ALUGAR', 'ALUGUEL', 1, 1, 1, 1, 1, 1, '-4.275843', '-55.987138', 1, 1, 'APARTAMENTO', '1', '1', '1', 'NOVA ITAITUBA', 'ITAITUBA', '', 'imóvel a venda', '1', 'img/imoveis/3-333', '2014-10-31 14:32:50'),
(4, 444, 'CASA A VENDA', 'VENDA', 1, 1, 1, 1, 1, 1, '-4.275843', '-55.994347', 1, 1, 'CASA TERREA', '1', '1', '1', 'BELA VISTA', 'ITAITUBA', '', 'descrição 4 descrição 4  sds sd sd sd descrição 4 descrição 4 descrição 4 descrição descrição 4 dff dfdf', '1', 'img/imoveis/4-444', '2014-11-03 19:30:43');
...
INSERT INTO `slideshow` (`id`, `slide`, `data_cadastro`) VALUES
(68, 'img/site/5452b176de681.jpg', '2014-10-30 21:45:19'),
(69, 'img/site/5452c4a632c90.jpg', '2014-10-30 23:07:18');
